...
in [the development guide](docs/content/project.md#development); this file covers the workflow and
conventions.
...
Fast commit hooks are optional; see [setup](docs/content/project.md#development). CI runs the
...
[docs/content/guides/adding-a-dataset.md](docs/content/guides/adding-a-dataset.md). In short:
...
- Design decisions that get argued about become an ADR in `docs/content/adr/`.
...
For documentation changes, see [maintaining the docs](docs/content/guides/documentation.md).
