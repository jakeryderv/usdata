...
Retrieved 2026-09-13 UTC. The whole source file is 6,473,552 bytes; SHA-256:
...
- four track points east of Greenwich written in the unwrapped 0-360 west
  ...
  previous point is `3.3W`. Of the 41 files the directory listed on 2026-09-13,
  8 contain such longitudes and the current Atlantic and Pacific files do not.
