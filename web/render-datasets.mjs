...
<section class="section" id="reference" aria-labelledby="reference-title"><h2 id="reference-title">Reference</h2><ul class="link-list"><li><a href="${escape(dataset.guide)}">Usage guide</a>: selection rules, what arrives, and what the service does not say</li><li><a href="${escape(dataset.reference)}">Catalog reference</a>: parameters, variables, coverage, and terms</li>${dataset.homepage ? `<li><a href="${escape(dataset.homepage)}">Upstream documentation</a> from ${escape(dataset.provider)}</li>` : ""}</ul>${dataset.citation ? `<p class="citation"><span>Cite as</span> ${escape(dataset.citation)}</p>` : ""}</section>`;
