...
- `docs/providers/<id>.md`: handwritten access notes per agency, linked to `docs/generated/catalog/`. Dataset guides are linked from generated reference through registry `catalog` metadata. Read before touching an adapter.
