...
[CONTRIBUTING.md](CONTRIBUTING.md); do not duplicate them here.
...
- `docs/providers/<id>.md`: handwritten access notes per agency, linked to `docs/generated/catalog/`. Dataset guides are linked from generated reference through each entry's `guide` path. Read before touching an adapter.
