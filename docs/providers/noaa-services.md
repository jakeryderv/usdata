...
Each registry entry names the product family or service behind it as its
`system`, and the [generated NOAA catalog](../generated/catalog/noaa.md) groups
the implemented datasets under that heading.
...
`USW00013967`. The [annual climate example](https://usdata.dev/datasets/noaa/gsoy/)
...
The [climate normals example](https://usdata.dev/datasets/noaa/climate-normals/) provides
