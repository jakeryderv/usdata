...
remain on GitHub; retired website version paths return 404.
...
Every pull request adds a [release-note fragment](https://github.com/jakeryderv/usdata/blob/main/changes/README.md).
