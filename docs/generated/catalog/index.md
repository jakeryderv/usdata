...
| <span id="noaacoops-tide-predictions"></span>[Coastal tide predictions](noaa/coops-tide-predictions.md) | Source only | CSV | Predictions for one station and datum on a chosen interval; at most a year |
