...
[docs/content/versioning.md](versioning.md).

See [provider access notes](providers/README.md),
[docs/content/architecture.md](architecture.md) for how the pieces fit,
[architecture decisions](adr/README.md) for why, and [CONTRIBUTING.md](../../CONTRIBUTING.md) to add
a dataset.
