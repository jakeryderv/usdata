...
The browser links to dataset references, usage guides, and executed examples in
the documentation. It does not query live inventories or upload dataset files.
