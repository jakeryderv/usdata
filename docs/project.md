...
[changelog](https://github.com/jakeryderv/usdata/blob/main/CHANGELOG.md) for published versions. Other providers are planned.
...
Browse the [dataset catalog](generated/catalog/index.md) for current support,
release availability, and dataset details. [Provider access notes](providers/README.md)
explain agency-specific services; the [roadmap](roadmap.md) describes priorities.
...
See [provider access notes](providers/README.md),
[docs/architecture.md](architecture.md) for how the pieces fit,
[architecture decisions](adr/README.md) for why, and [CONTRIBUTING.md](https://github.com/jakeryderv/usdata/blob/main/CONTRIBUTING.md) to add
a dataset.

## License

[Apache-2.0](https://github.com/jakeryderv/usdata/blob/main/LICENSE).
