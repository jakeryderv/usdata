...
Open [noaa-goes-abi.ipynb](noaa-goes-abi.ipynb) to see an executed GOES-18 channel-13 scene,
quality-filtered brightness-temperature image in scan coordinates, and pixel
histogram. Available since v0.8.

Use [notebook setup](https://usdata.dev/studies/#run) from the repository root. The NetCDF reader
