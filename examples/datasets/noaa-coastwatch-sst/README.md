...
Open the [executed notebook](noaa-coastwatch-sst.ipynb) to inspect four CoastWatch ocean grid
centers, their units and provenance, a small spatial plot, and cache reuse.
See [examples setup](https://usdata.dev/studies/#run) to run it interactively or refresh its outputs.
...
the underlying data. The [reader reference](https://docs.usdata.dev/reference/readers/)
