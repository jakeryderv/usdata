...
Open the [executed notebook](noaa-gsom.ipynb) to inspect May 2024 precipitation and
mean temperature at Will Rogers World Airport, plot both measurements, and verify
the manifest's locked inputs. See [examples setup](https://usdata.dev/studies/#run) to run it.
...
checksums and shows lockfile/cache reuse. See [NOAA access notes](https://docs.usdata.dev/providers/noaa-gsom/)
