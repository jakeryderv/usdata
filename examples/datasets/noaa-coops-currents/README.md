...
The [executed notebook](noaa-coops-currents.ipynb) plots one UTC day of observed current
...
Follow the [examples setup](https://usdata.dev/studies/#run), then open
`examples/datasets/noaa-coops-currents/noaa-coops-currents.ipynb`.
...
the [dated metadata snapshot](https://github.com/jakeryderv/usdata/blob/main/examples/datasets/noaa-coops-currents/metadata.json).
