...
| [Hourly temperature departures](https://usdata.dev/examples/hourly-anomalies/) | One airport's routine observations against hourly normals, explicit local-standard-time matching, missing-value counts, and fresh-cache restoration (available from source for the unreleased v0.23.0) |
