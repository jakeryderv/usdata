...
| [GOES mesoscale evolution](https://usdata.dev/examples/goes-mesoscale/) | Fifteen minutes of one mesoscale sector, explicit timing and quality checks, a fixed-region comparison, and pinned restoration (available since v0.25.0) |
