...
| [Cape Henry currents](https://usdata.dev/examples/coastal-currents/) | One day of speed and direction for an explicit station and bin, gap counts, dated metadata, and fresh-cache restoration (available from source for the unreleased v0.24.0) |
