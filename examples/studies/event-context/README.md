...
Open the [executed notebook](event-context.ipynb) to reproduce the selection of a KTLX
...
root; see the [examples guide](https://usdata.dev/studies/#run) for setup and fresh-kernel checks.
