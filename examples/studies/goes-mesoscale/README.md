...
The [executed notebook](goes-mesoscale.ipynb) compares GOES-16 channel-13 mesoscale
...
[examples setup](https://usdata.dev/studies/#run). Open
`examples/studies/goes-mesoscale/goes-mesoscale.ipynb`. The existing example environment supplies
