...
Open the [executed notebook](weather-and-streamflow.ipynb) to inspect a two-source manifest, fetch
NOAA weather and USGS streamflow, view their data and provenance, and verify and
restore the locked inputs. See [examples setup](https://usdata.dev/studies/#run) to run it.
...
cached bytes when you need a durable archive. The [manifest reference](https://docs.usdata.dev/reference/manifests/)
