...
Open the [executed notebook](storm-surge.ipynb) to subtract CO-OPS tide predictions
...
or a return-period estimate. See [examples setup](https://usdata.dev/studies/#run) to run it.
